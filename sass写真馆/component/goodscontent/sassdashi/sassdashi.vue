<template>
	<view class="sass-box">
		...
		<view class="font">SASS MASTER</view>
			...
			<uni-swiper-dot  :current="current" field="content" :mode="mode" :dots-styles="dotsStyles">
				...
				<swiper :autoplay="true" :interval="3000" :duration="1000" circular class="swiper-warps"
					...
					<swiper-item class="swiper-item" >
						<image  src="../../../static/LB/sassdashiLB1.png"></image>
					</swiper-item>
					<swiper-item class="swiper-item" >
						<image  src="../../../static/LB/sassdashiLB2.png"></image>
					</swiper-item>
				</swiper>
			</uni-swiper-dot>
		</view>
		...
		<view class="unique">
			<view class="part-header" @tap="todetail">
				<view class="part-font">
					UNIQUE
					<p style="font-size: 14px; font-weight: 500; ">大师臻选</p>
				</view>
		...
		methods: {
			...
			async  getunique() {
				await this.common.get('/api/getswiper',[]).then((res) => {
					this.courseList=res.data.splice(15,16)
...
<style lang="scss" scoped>
	...
	.header {
		width: 100%;
		height: 10rpx;
		background: linear-gradient(to right, #784200, #ff8f00,#ffd902);
	}
