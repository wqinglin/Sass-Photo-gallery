			...
			<uni-swiper-dot :current="current" field="content" :mode="mode" :dots-styles="dotsStyles">
				...
				<swiper :autoplay="true" :interval="3000" :duration="1000" circular class="swiper-warps"
					...
					<swiper-item class="swiper-item">
						<image src="../../../static/LB/sasschildLB1.png"></image>
					</swiper-item>
					<swiper-item class="swiper-item">
						<image src="../../../static/LB/sasschildLB2.png"></image>
					</swiper-item>
				</swiper>
			</uni-swiper-dot>
		</view>
		...
		<view class="unique">
			<view class="part-header"  @tap="todetail">
				<view class="part-font">
					UNIQUE
					<p style="font-size: 14px; font-weight: 500; ">宝贝照</p>
				</view>
				<view style="font-size: 27px; font-weight: 600; color: #000000; margin-top: 10%;">></view>
			</view>
			<view class="goods-box">

				<view class="item" v-for="course in childList" :key="course.id">
		...
		methods: {
			...
			async getunique() {
				await this.common.get('/api/getswiper', []).then((res) => {
					this.childList = res.data.splice(21,22)
...
<style lang="scss" scoped>
	...
	.header {
		width: 100%;
		height: 10rpx;
		background: linear-gradient(to right, #ff9a27, #ffef0c);
	}
