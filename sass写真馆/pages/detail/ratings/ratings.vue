	...
	export default {
		data() {
			return {
				...
				labelIndex:0,
				ratingsList:[
					{id:1,username:"客户1",face:"/static/img/face.jpg",date:'2019-04-21',grade:"good",
						first:{content:"服务态度太好了吧！拍照也很专业！超级满意",
						img:["https://imgnew.zhichikeji.com/zcimgdir/album/file_5fe58c26088bd.png","https://imgnew.zhichikeji.com/zcimgdir/album/file_5fe58da9d95f1.png"],
						},
						append:{date:65,content:"回看结婚照，还是百分百满意",
						img:["https://imgnew.zhichikeji.com/zcimgdir/album/file_5fe58c286ce6a.png","https://imgnew.zhichikeji.com/zcimgdir/album/file_5fe58f5163968.png"],
						}
					},
					{id:2,username:"客户2",face:"/static/img/face.jpg",date:'2019-04-21',grade:"secondary",
						first:{content:"好评，看图",
						video:[]
						}
					},
					{id:3,username:"客户3",face:"/static/img/face.jpg",date:'2019-04-21',grade:"poor",
						first:{content:"好评，看图",
						video:[]
						}
					},
					{id:3,username:"客户4",face:"/static/img/face.jpg",date:'2019-04-21',grade:"secondary",
			...
			.right{
				...
				.append{
					...
					.date{
						width: 100%;
						height: 40upx;
						border-left: 10upx solid #1a7785;
						padding-left: 10upx;
						align-items: center;
						font-size: 32upx;
						margin: 20upx 0;
