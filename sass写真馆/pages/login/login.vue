<template>
	<view class="register">
		...
		<view class="main1">
			...
			<view class="item">
				<image class="login_image" src="../../static/my_img/zhanghao.png"></image>
				<input v-model="mobile" class="main-input" placeholder="请输入账号" style="color: #FFFFFF;" />
			</view>
			<view style="margin-top: 8px"></view>
			<view class="item">
				<image class="login_image" src="../../static/my_img/mima.png"></image>
		...
		<view class="other_login cuIcon">
			<view class="login_icon_wx">
				<image  style="width: 80rpx;height: 80rpx;margin: 20rpx;" src="../../static/my_img/wx.png" @tap="login_weixin">
				</image>
				<image  style="width: 80rpx;height: 80rpx; margin: 20rpx;" src="../../static/my_img/qq.png" @tap="login_weixin">
				</image>
	...
	export default {
		...
		methods: {
			...
			async toLogin(e) {
				...
				await this.common.post('/api/login', {
					mobile: this.mobile,
...
<style>
	page { 
		background: url(../../static/my_img/bgimg2.jpg)no-repeat;
		width: 100%;
		height: 100%;
